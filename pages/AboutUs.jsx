        ...
        <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4">
            <div className="flex lg:flex-row flex-col lg:gap-8 sm:gap-10 gap-12">
                <div className="w-full lg:w-6/12">
                    ...
                    <p className="font-normal text-base leading-6 text-gray-600 mt-6">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quod nesciunt iste temporibus, corrupti quas dolores, totam asperiores laborum ut ducimus exercitationem eum modi, reiciendis voluptates. Aperiam ipsum rem eos dolor libero, totam nobis corrupti at dolores, fugit maiores corporis accusamus eligendi, ut ex sit tenetur expedita earum possimus? Esse, illum!</p>
                </div>
                <div className="w-full lg:w-6/12">
            ...
            <div className="grid sm:grid-cols-3 grid-cols-2 sm:gap-8 gap-4">
                <div>
                    ...
                    <p className="font-normal text-base leading-6 text-gray-600 mt-6">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Blanditiis, dolores eligendi suscipit minima amet asperiores eum pariatur quas nihil dolore?</p>
                </div>
                <div>
                    <p className="font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 text-gray-800 mt-6">50M montly enrichments</p>
                    <p className="font-normal text-base leading-6 text-gray-600 mt-6">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ullam delectus minus laborum nostrum velit voluptates neque corrupti optio amet dicta?</p>
                </div>
                <div className="sm:block hidden">
                    <p className="font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 text-gray-800 mt-6">400k User</p>
                    <p className="font-normal text-base leading-6 text-gray-600 mt-6">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ea asperiores sint accusamus molestiae repellat, reprehenderit velit impedit. Ducimus, molestiae ipsam.</p>
                </div>
            </div>
            ...
            <div className="sm:hidden grid sm:grid-cols-3 grid-cols-2 sm:gap-8 gap-4">
                <div>
                    <p className="font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 text-gray-800 mt-6">400k User</p>
                    <p className="font-normal text-base leading-6 text-gray-600 mt-6">Lorem ipsum dolor sit amet consectetur adipisicing elit. Vitae illo laudantium, deserunt cumque facere provident libero corporis praesentium incidunt adipisci.</p>
                </div>
            </div>
            ...
            <div className="flex lg:flex-row flex-col md:gap-14 gap-16 justify-between lg:mt-20 mt-16">
                <div className="w-full lg:w-6/12">
                    ...
                    <p className="font-normal text-base leading-6 text-gray-600 mt-6 w-full lg:w-10/12 xl:w-9/12">Lorem ipsum dolor sit amet consectetur adipisicing elit. Eaque qui voluptate nemo. Recusandae, dolor numquam harum nemo impedit necessitatibus perferendis eos odit, amet placeat nihil similique reprehenderit architecto id? Magni pariatur quisquam exercitationem ut vitae alias vero quae, minus rerum rem molestias earum, commodi nisi, molestiae repellendus cupiditate eos eligendi.</p>
                    <p className="font-normal text-base leading-6 text-gray-600 w-full lg:w-10/12 xl:w-9/12 mt-10">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Repellat esse illo ut, ipsum incidunt eius fugit! Qui, corporis. Et, rem. Voluptatibus porro architecto consequatur! Molestiae officia vero accusamus, atque consectetur iure, culpa nam eveniet magnam tenetur itaque perferendis laborum quidem esse. Quod, praesentium. Iste enim iure obcaecati dolorum quam. Qui.</p>
                </div>
                <div className="w-full lg:w-6/12">
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 lg:gap-12 gap-10">
                        ...
                        <div className="flex p-4 shadow-md">
                            ...
                            <div className="">
                                ...
                                <p className="mt-2 font-normal text-base leading-6 text-gray-600">Lorem ipsum dolor, sit amet consectetur adipisicing elit. At perferendis laboriosam repudiandae atque. Maxime eligendi atque, eum sapiente qui nisi.</p>
                            </div>
                        </div>
                        ...
                        <div className="flex p-4 shadow-md">
                            ...
                            <div className="">
                                ...
                                <p className="mt-2 font-normal text-base leading-6 text-gray-600">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Facilis modi ut possimus nobis odio velit, officiis voluptatibus asperiores perferendis nulla!</p>
                            </div>
                        </div>
                        ...
                        <div className="flex p-4 shadow-md">
                            ...
                            <div className="">
                                ...
                                <p className="mt-2 font-normal text-base leading-6 text-gray-600">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Maiores exercitationem, iusto dolorem a rerum dolor modi amet obcaecati. Recusandae, accusamus!</p>
                            </div>
                        </div>
                    </div>
                </div>
